...
#define DEFAULT_AXIS_STEPS_PER_UNIT                                                   \
  {                                                                                   \
    CONF_X_PULLEY_STEPS, CONF_Y_PULLEY_STEPS, CONF_Z_STEPS, CONF_FILAMENT_MOTOR_STEPS \
  } // default steps per unit for Makergear M2plus
...
#define DEFAULT_MAX_FEEDRATE                                                           \
  {                                                                                    \
    CONF_MAX_FEEDRATE_X, CONF_MAX_FEEDRATE_Y, CONF_MAX_FEEDRATE_Z, CONF_MAX_FEEDRATE_E \
  } // (mm/sec)
...
#define DEFAULT_MAX_ACCELERATION                                                                       \
  {                                                                                                    \
    CONF_MAX_ACCELERATION_X, CONF_MAX_ACCELERATION_Y, CONF_MAX_ACCELERATION_Z, CONF_MAX_ACCELERATION_E \
...
#define SERVO_DELAY \
  {                 \
    300, 300, 300   \
  } //added two more entries - by Josh for BLTouch testing - 10/24/1017
